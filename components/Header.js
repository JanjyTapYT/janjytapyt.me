const items = [
    { icon: 'fab fa-spotify', link: 'https://open.spotify.com/user/k4cludp12lvy00h9uaswt2pv6?si=42fcbb9c43ba4698' },
    ...
    return <>
        <div className="w-full border-b-2 border-[#191932]/10 pb-2">
            <div className="flex flex-col md:flex-row w-full items-center md:justify-between">
                <p className="font-semibold font-Poppins text-xl">JanjyTaPYT</p>
