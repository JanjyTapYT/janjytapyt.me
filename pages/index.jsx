...
const items = [
  {
    icon: "fab fa-spotify",
    link: "https://open.spotify.com/user/k4cludp12lvy00h9uaswt2pv6?si=9c6a7e925bdd4bc4",
  },
  { icon: "fab fa-instagram", link: "https://instagram.com/janjytap.yt" },
  { icon: "fab fa-github", link: "https://github.com/JanjyTapYT" },
  {
    icon: "fab fa-discord",
    link: "https://discord.com/users/679407120743137300",
  },
];
        ...
        profile ? (
          <div className="relative">
            <div className="flex flex-col lg:flex-row justify-between w-full p-6 px-8 items-center h-full">
              <div className="flex flex-col lg:justify-start justify-center items-center lg:items-start mt-5 lg:mt-0 w-full">
                <div className="flex items-center">
                  ...
                  <p className="text-white/50 text-md mt-3">
                    Hi, I`m JanjyTapYT. I am a 2nd year high school student and I have
              ...
              >
                Self-taught Web and Application Developer
              </span>
            </div>
          ) : (
            <div className="flex flex-col lg:flex-row justify-between w-full p-6 px-8 items-center h-full">
