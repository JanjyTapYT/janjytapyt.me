        ...
        <div className="grid grid-cols-1 md:grid-cols-2 divide-x divide-gray-200 h-full w-full gap-6 mt-6">
          ...
          <div>
            <div className="space-y-4 p-4">
                ...
                <a href={'mailto:janjytap2.0@gmail.com'} className="flex justify-between cursor-pointer hover:bg-zinc-300/50 transition-all duration-200 items-center bg-zinc-100 px-4 py-2 rounded-xl">
                  <p className="text-xl">Email</p>
                  <i className="fa fa-envelope text-2xl" />
                </a>
                <a href={'https://discord.gg/5t6S5T53Kd'} target="_blank" className="flex justify-between cursor-pointer hover:bg-zinc-300/50 transition-all duration-200 items-center bg-zinc-100 px-4 py-2 rounded-xl">
                  <p className="text-xl">Discord</p>
                  <i className="fab fa-discord text-2xl" />
                </a>
                <a href={'https://twitter.com/stoneclane'} target="_blank" className="flex justify-between cursor-pointer hover:bg-zinc-300/50 transition-all duration-200 items-center bg-zinc-100 px-4 py-2 rounded-xl">
                  <p className="text-xl">Twitter</p>
                  <i className="fab fa-twitter text-2xl" />
                </a>
                <a href={'https://instagram.com/janjytap.yt'} target="_blank" className="flex justify-between cursor-pointer hover:bg-zinc-300/50 transition-all duration-200 items-center bg-zinc-100 px-4 py-2 rounded-xl">
