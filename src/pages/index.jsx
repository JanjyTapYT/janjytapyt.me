        ...
        <div className="hidden lg:block absolute w-full bottom-20">
          {user?.username && (
            <div className="w-full flex justify-center items-center space-x-4">
              <img style={{ zIndex: 2 }} draggable={false} className={`transition-all ${slideAvatar ? 'translate-x-0' : 'translate-x-72'} duration-500 rounded-full flex-shrink-0`} width="172" height="72" src={`https://cdn.discordapp.com/avatars/${_user?.id}/${_user?.avatar}?size=4096`} />
