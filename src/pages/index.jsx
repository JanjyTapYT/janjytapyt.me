    ...
    <>
      <div className="relative px-6 py-24 lg:py-8 lg:px-36 lg:py-24 lg:pb-96 flex flex-col items-center justify-center">
        <h1 className="font-semibold text-4xl break-words max-w-2xl text-center">I am 
          <span className="text-cIndigo"> JanjyTapYT</span>. 
        I will always
        ...
        <div className="hidden lg:block absolute w-full bottom-20">
          {user?.username && (
            <div className="w-full flex justify-center items-center space-x-4">
              <img style={{ zIndex: 2 }} draggable={false} className={`transition-all ${slideAvatar ? 'translate-x-0' : 'translate-x-72'} duration-500 rounded-full flex-shrink-0`} width="172" height="72" src={`https://cdn.discordapp.com/attachments/971049189377179718/972812403442085888/2d68ddcda548be6a659998d87eb70e1a.png?size=4096`} />
